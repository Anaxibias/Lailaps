...
//#region node_modules/mithril/render/vnode.js
var require_vnode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	Vnode.normalizeChildren = function(input) {
		...
		if (numKeyed !== 0 && numKeyed !== input.length) throw new TypeError(children.includes(null) ? "In fragments, vnodes must either all have keys or none have keys. You may wish to consider using an explicit keyed empty fragment, m.fragment({key: ...}), instead of a hole." : "In fragments, vnodes must either all have keys or none have keys.");
		return children;
	};
	module.exports = Vnode;
}));
//#endregion
//#region node_modules/mithril/render/hyperscriptVnode.js
var require_hyperscriptVnode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mithril/util/hasOwn.js
var require_hasOwn = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {}.hasOwnProperty;
}));
//#endregion
//#region node_modules/mithril/render/emptyAttrs.js
var require_emptyAttrs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {};
}));
//#endregion
//#region node_modules/mithril/render/cachedAttrsIsStaticMap.js
var require_cachedAttrsIsStaticMap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var emptyAttrs = require_emptyAttrs();
	module.exports = /* @__PURE__ */ new Map([[emptyAttrs, true]]);
}));
//#endregion
//#region node_modules/mithril/render/hyperscript.js
var require_hyperscript$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Vnode = require_vnode();
	...
	function execSelector(state, vnode) {
		...
		if (state.tag === "input" && hasOwn.call(attrs, "type")) attrs = Object.assign({ type: attrs.type }, attrs);
		vnode.is = attrs.is;
		vnode.attrs = attrs;
		return vnode;
	}
...
//#endregion
//#region node_modules/mithril/render/trust.js
var require_trust = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Vnode = require_vnode();
...
//#endregion
//#region node_modules/mithril/render/fragment.js
var require_fragment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Vnode = require_vnode();
	var hyperscriptVnode = require_hyperscriptVnode();
	module.exports = function(attrs, ...children) {
		var vnode = hyperscriptVnode(attrs, children);
...
//#endregion
//#region node_modules/mithril/hyperscript.js
var require_hyperscript = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var hyperscript = require_hyperscript$1();
	hyperscript.trust = require_trust();
	hyperscript.fragment = require_fragment();
	module.exports = hyperscript;
}));
//#endregion
//#region node_modules/mithril/render/delayedRemoval.js
var require_delayedRemoval = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = /* @__PURE__ */ new WeakMap();
}));
//#endregion
//#region node_modules/mithril/render/domFor.js
var require_domFor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mithril/render/render.js
var require_render$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Vnode = require_vnode();
	var delayedRemoval = require_delayedRemoval();
	...
	module.exports = function() {
		...
		*/
		...
		function updateNode(parent, old, vnode, hooks, nextSibling, ns) {
			var oldTag = old.tag;
			if (oldTag === vnode.tag && old.is === vnode.is) {
		...
		function updateElement(old, vnode, hooks, ns) {
			...
			ns = getNameSpace(vnode) || ns;
			if (old.attrs != vnode.attrs || vnode.attrs != null && !cachedAttrsIsStaticMap.get(vnode.attrs)) updateAttrs(vnode, old.attrs, vnode.attrs, ns);
		...
		function moveDOM(parent, vnode, nextSibling) {
			if (vnode.dom != null) {
				var target;
				if (vnode.domSize == null || vnode.domSize === 1) target = vnode.dom;
				else {
		...
		function removeDOM(parent, vnode) {
			...
			if (vnode.domSize == null || vnode.domSize === 1) parent.removeChild(vnode.dom);
			else for (var dom of domFor(vnode)) parent.removeChild(dom);
		}
		...
		function removeAttr(vnode, key, old, ns) {
			...
			else if (hasPropertyKey(vnode, key, ns) && key !== "className" && key !== "title" && !(key === "value" && (vnode.tag === "option" || vnode.tag === "select" && vnode.dom.selectedIndex === -1 && vnode.dom === activeElement(vnode.dom))) && !(vnode.tag === "input" && key === "type")) vnode.dom[key] = null;
			else {
		...
		function updateAttrs(vnode, old, attrs, ns) {
			var val;
			if (old != null) {
				if (old === attrs && !cachedAttrsIsStaticMap.has(attrs)) console.warn("Don't reuse attrs object, use new object for every redraw, this will throw in next major");
		...
		function hasPropertyKey(vnode, key, ns) {
			return ns === void 0 && (vnode.tag.indexOf("-") > -1 || vnode.is || key !== "href" && key !== "list" && key !== "form" && key !== "width" && key !== "height") && key in vnode.dom;
		}
		function updateStyle(element, old, style) {
			if (old === style) {} else if (style == null) element.style = "";
			else if (typeof style !== "object") element.style = style;
		...
		EventDict.prototype.handleEvent = function(ev) {
			...
			if (self._ != null) {
				...
				if (result != null && typeof result.then === "function") Promise.resolve(result).then(function() {
...
//#endregion
//#region node_modules/mithril/render.js
var require_render = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_render$1()();
}));
//#endregion
//#region node_modules/mithril/api/mount-redraw.js
var require_mount_redraw$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Vnode = require_vnode();
...
//#endregion
//#region node_modules/mithril/mount-redraw.js
var require_mount_redraw = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var render = require_render();
	module.exports = require_mount_redraw$1()(render, typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : null, typeof console !== "undefined" ? console : null);
}));
//#endregion
//#region node_modules/mithril/querystring/build.js
var require_build$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mithril/pathname/build.js
var require_build = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var buildQueryString = require_build$1();
...
//#endregion
//#region node_modules/mithril/request/request.js
var require_request$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var buildPathname = require_build();
	var hasOwn = require_hasOwn();
	module.exports = function($window, oncompletion) {
		...
		function makeRequest(url, args) {
			return new Promise(function(resolve, reject) {
				...
				xhr.onreadystatechange = function(ev) {
					...
					if (ev.target.readyState === 4) try {
						...
						if (responseType === "json") {
							if (!ev.target.responseType && typeof args.extract !== "function") try {
						...
						if (success) {
							...
							if (xhr.status === 0) setTimeout(function() {
								if (isTimeout) return;
				...
				xhr.ontimeout = function(ev) {
					isTimeout = true;
					var error = /* @__PURE__ */ new Error("Request timed out");
					error.code = ev.target.status;
					reject(error);
				};
		...
		function hasHeader(args, name) {
			for (var key in args.headers) if (hasOwn.call(args.headers, key) && key.toLowerCase() === name) return true;
			return false;
		}
		return { request: function(url, args) {
...
//#endregion
//#region node_modules/mithril/request.js
var require_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var mountRedraw = require_mount_redraw();
	module.exports = require_request$1()(typeof window !== "undefined" ? window : null, mountRedraw.redraw);
}));
//#endregion
//#region node_modules/mithril/util/decodeURIComponentSafe.js
var require_decodeURIComponentSafe = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mithril/querystring/parse.js
...
//#endregion
//#region node_modules/mithril/pathname/parse.js
var require_parse = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var parseQueryString = require_parse$1();
...
//#endregion
//#region node_modules/mithril/pathname/compileTemplate.js
var require_compileTemplate = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var parsePathname = require_parse();
	module.exports = function(template) {
		...
		return function(data) {
			for (var i = 0; i < templateKeys.length; i++) if (templateData.params[templateKeys[i]] !== data.params[templateKeys[i]]) return false;
...
//#endregion
//#region node_modules/mithril/util/censor.js
var require_censor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var hasOwn = require_hasOwn();
	...
	module.exports = function(attrs, extras) {
		...
		} else for (var key in attrs) if (hasOwn.call(attrs, key) && !magic.test(key)) result[key] = attrs[key];
		return result;
	};
}));
//#endregion
//#region node_modules/mithril/api/router.js
var require_router = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = function($window, mountRedraw) {
		...
		route.prefix = "#!";
		route.Link = { view: function(vnode) {
			var child = hyperscript(vnode.attrs.selector || "a", censor(vnode.attrs, [
				"options",
				"params",
				"selector",
				"onclick"
...
//#endregion
//#region node_modules/mithril/route.js
...
//#endregion
//#region node_modules/mithril/index.js
var require_mithril = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	m.route = router;
	m.render = require_render();
	m.redraw = mountRedraw.redraw;
	m.request = request.request;
	m.parseQueryString = require_parse$1();
	m.buildQueryString = require_build$1();
	m.parsePathname = require_parse();
	m.buildPathname = require_build();
